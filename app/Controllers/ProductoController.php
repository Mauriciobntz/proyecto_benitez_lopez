...
use App\Models\ProductoMediaModel;
...
class ProductoController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->productoMediaModel = new ProductoMediaModel();
    }
    ...
    public function listar()
    {
        ...
        return view('header', $data) . view('navbar') . view('productos_lista') . view('footer');
    }
...
public function guardarProducto()
{
    ...
    if ($this->productoModel->insert($data)) {
        ...
        return redirect()->to('productos/' . $productoId)->with('message', 'Producto agregado correctamente');
    } else {
...
public function actualizarProducto()
{
    ...
    if ($this->productoModel->update($producto_id, $data)) {
        return redirect()->to('productos/' . $producto_id)->with('message', 'Producto actualizado correctamente');
    } else {
...
private function registrarCambioPrecio($productoId, $precioAnterior, $precioNuevo)
{
    ...
    public function detalle($producto_id)
    {
        ...
        $media = $this->productoMediaModel->getMediaByProducto($producto_id);
        ...
        return view('header', $data) . view('navbar') . view('producto_detalle') . view('footer');
    }
