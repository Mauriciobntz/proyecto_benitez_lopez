<div class="container mt-4">
    ...
    <form action="<?= isset($producto) ? '/admin/productos/actualizar/' . $producto['id_producto'] : '/admin/productos/guardar' ?>" 
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" 
                                      rows="3" required><?= old('descripcion', $producto['descripcion'] ?? '') ?></textarea>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div id="especificaciones-container">
                            <?php 
                            $especificaciones = isset($producto['especificaciones']) ? 
            ...
            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="precio" name="precio" 
                                   value="<?= old('precio', $producto['precio'] ?? '0') ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="garantia_meses" name="garantia_meses" 
                                   value="<?= old('garantia_meses', $producto['garantia_meses'] ?? '12') ?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="activo" name="activo">
                                <option value="1" <?= old('activo', $producto['activo'] ?? '1') == '1' ? 'selected' : '' ?>>Activo</option>
                                <option value="0" <?= old('activo', $producto['activo'] ?? '1') == '0' ? 'selected' : '' ?>>Inactivo</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <?php if (isset($producto) && !empty($producto['imagen_url'])): ?>
                            <img src="<?= $producto['imagen_url'] ?>" class="img-fluid mb-3" alt="Imagen actual">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        if (e.target.classList.contains('remove-especificacion')) {
