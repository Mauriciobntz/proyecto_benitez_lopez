...
<div class="container-fluid p-0">
  ...
  <section class="container-fluid mt-5">
    <div class="row">
      <!-- Menú lateral -->
      <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar mt-3">
...
function ordenarProductos(criterio) {
  // Implementar lógica de ordenación con AJAX o JavaScript
  // Esto podría hacer una llamada al servidor o ordenar client-side
  console.log("Ordenar por: " + criterio);
  
  // Ejemplo básico de ordenación client-side (solo para demostración)
  ...
  // Limpiar y volver a agregar los productos ordenados
  container.innerHTML = '';
