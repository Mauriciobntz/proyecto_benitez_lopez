...
<section>
  ...
  <nav class="navbar navbar-expand-lg bg-dark">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      <!-- Main Navbar Toggle Button (para abrir el offcanvas en pantallas pequeñas) -->
      ...
      <div class="d-none d-lg-block">
        ...
        <?php if (session()->get('logged_in')): ?>
          <div class="btn-group">
            <span class=" text-center text-white fw-bold me-2">
              <?= session()->get('username') ?>
            </span>
            <a href="<?php echo base_url('logout'); ?>" class="btn btn-light rounded-pill">
              <img src="<?php echo base_url('assets/img/person.svg'); ?>" alt="">
            </a>
          </div>
        <?php else: ?>
          <a href="<?php echo base_url('login'); ?>" class="btn btn-light rounded-pill">
            <img src="<?php echo base_url('assets/img/person.svg'); ?>" alt="">
          </a>
        <?php endif; ?>
      </div>
  ...
  <!-- Offcanvas (solo visible en pantallas pequeñas) -->
