...
$masVendidos = $productoModel->getProductosMasVendidos(4); // Obtener 4 más vendidos
?>

<!-- Cards de Productos mas vendidos -->
<div class="new-arrivals py-5 mt-3">
  <div class="container">
    <div class="section-header text-center mb-5">
      <h2 class="fw-bold mb-3">MAS VENDIDOS</h2>
    </div>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="card h-100 border-0 shadow-sm rounded-3 overflow-hidden transition-all hover-shadow">
          <div class="product-media position-relative">
            ...
            <?php endif; ?>
            <div class="product-badge bg-warning text-white position-absolute top-0 end-0 m-3 px-2 py-1 rounded-pill small">
              Top ventas
            </div>
          </div>
          <div class="card-body text-center pt-4 pb-3">
            ...
            <div class="d-flex justify-content-center mt-2">
                      <a href="<?= base_url('productos/'.$producto['id_producto']) ?>" class="btn btn-warning text-white col-9 rounded-pill">Ver detalles</a>
            </div>
          </div>
        </div>
      </div>
