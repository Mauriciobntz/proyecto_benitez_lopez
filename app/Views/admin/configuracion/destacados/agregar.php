<div class="container mt-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('admin/configuracion/destacados/guardar') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <!-- Preview del video (se mostrará después de seleccionar) -->
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">Guardar Producto Destacado</button>
                </div>
            </form>
        </div>
    </div>
