    ...
    <div class="invoice-container">
        <div class="invoice-header">
            <div class="row">
                ...
                <div class="col-md-6 d-flex flex-column align-items-end">
                    ...
                    <p>
                        <strong>N°:</strong> <?= str_pad($venta['id_venta'], 8, '0', STR_PAD_LEFT) ?><br>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <p>
                    <strong>Pedido #<?= $venta['id_venta'] ?></strong><br>
                    ...
                    <?php if (isset($pago)): ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    Estado del Pedido: <?= ucfirst($venta['estado'] ?? 'No especificado') ?>
                </p>
            </div>
        </div>
        ...
        <table class="table table-invoice table-bordered mb-4">
            ...
            <tfoot>
                ...
                <tr class="table-active">
                    ...
                    <td class="text-end fw-bold">$<?= number_format($venta['total'] ?? $subtotal, 2) ?></td>
                </tr>
            </tfoot>
        </table>
        ...
        <div class="text-center mt-4">
            ...
            <div class="d-flex justify-content-center gap-3">
                ...
                <a href="<?= base_url('admin/ventas/listar') ?>" class="btn btn-outline-secondary">
