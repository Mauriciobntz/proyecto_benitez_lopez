  ...
  <div class="text-center">
    <div class="flex justify-center w-100">
      <a href="/medios-de-pago" title="Promociones financieras | EASY" rel="" class="">
        <img title="Promociones financieras | EASY" alt="Promociones financieras | EASY" class="img-fluid" src="https://arcencohogareasy.vtexassets.com/assets/vtex.file-manager-graphql/images/a83279ef-e3cb-454f-8add-9ca30b5bfd4f___6f44803169ce30a8d9dab97e27741824.gif" loading="lazy">
      </a>
    </div>
  </div>
</header>
...
<nav class="navbar navbar-expand-lg bg-dark">
  <div class="container-fluid d-flex justify-content-between align-items-center">
    ...
    <!-- Logo -->
    <a class="navbar-brand text-white mx-auto" href="http://localhost/proyecto_benitez_lopez/principal" style="flex-grow: 1; text-align: center;">
      <b>FOLLOW</b>
    </a>
    ...
    <ul class="navbar-nav mx-auto d-none d-lg-flex">
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="http://localhost/proyecto_benitez_lopez/celulares">Celulares</a></li>
          <li><a class="dropdown-item" href="http://localhost/proyecto_benitez_lopez/notebooks">Notebooks</a></li>
          <li><a class="dropdown-item" href="http://localhost/proyecto_benitez_lopez/tablets">Tablets</a></li>
          <li><a class="dropdown-item" href="http://localhost/proyecto_benitez_lopez/auriculares">Auriculares</a></li>
        </ul>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white fw-bold" href="http://localhost/proyecto_benitez_lopez/principal">Principal</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white fw-bold" href="http://localhost/proyecto_benitez_lopez/somos">Quienes Somos</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white fw-bold" href="http://localhost/proyecto_benitez_lopez/comercializacion">Comercializacion</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white fw-bold" href="http://localhost/proyecto_benitez_lopez/contacto">Contacto</a>
      </li>
    </ul>
    ...
    <div class="d-none d-lg-block">
      <button class="btn btn-light rounded-pill" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight">
        <i class="fas fa-shopping-cart"></i>
      </button>
      <a href="http://localhost/proyecto_benitez_lopez/login" class="btn btn-light rounded-pill">
...
<div class="offcanvas offcanvas-start" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop">
  ...
  <div class="offcanvas-body">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      <li class="nav-item">
        <a class="nav-link active" href="http://localhost/proyecto_benitez_lopez/principal">Principal</a>
      </li>
      <li class="nav-item dropdown">
      ...
      <li class="nav-item">
        <a class="nav-link" href="http://localhost/proyecto_benitez_lopez/somos">Quienes Somos</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="http://localhost/proyecto_benitez_lopez/comercializacion">Comercializacion</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="http://localhost/proyecto_benitez_lopez/contacto">Contacto</a>
      </li>
    </ul>
  </div>
</div>
  ...
  <div class="offcanvas-body d-flex flex-column align-items-center" style="overflow-x: hidden;">
    <div class="card mb-3 w-100 overflow-hidden" style="max-height: 120px;">
      <div class="row g-0 align-items-center">
        <div class="col-4">
          <img src="http://localhost/proyecto_benitez_lopez/assets/img/zapatilla.jpg" class="img-fluid rounded-start d-block" alt="Producto">
        </div>
        <div class="col-8">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <?php if (session('rol') === 'admin'): ?>
              ...
              <li><a class="dropdown-item" href="<?= base_url('admin') ?>"><i class="fas fa-cog me-2"></i>Panel Admin</a></li>
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <?php if (session('logged_in')): ?>
        <li class="nav-item mt-3 border-top pt-2">
          <a class="nav-link" href="<?= base_url('perfil') ?>"><i class="fas fa-user-circle me-2"></i>Mi Perfil</a>
        </li>
        <?php if (session('rol') === 'admin'): ?>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('admin') ?>"><i class="fas fa-cog me-2"></i>Panel Admin</a>
          </li>
        <?php endif; ?>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('mis-pedidos') ?>"><i class="fas fa-box-open me-2"></i>Mis Pedidos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-danger" href="<?= base_url('logout') ?>"><i class="fas fa-sign-out-alt me-2"></i>Cerrar Sesión</a>
        </li>
      <?php else: ?>
        <li class="nav-item mt-3 border-top pt-2">
          <a class="nav-link" href="<?= base_url('login') ?>"><i class="fas fa-sign-in-alt me-2"></i>Iniciar Sesión</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('sign') ?>"><i class="fas fa-user-plus me-2"></i>Registrarse</a>
        </li>
      <?php endif; ?>
    </ul>
  </div>
